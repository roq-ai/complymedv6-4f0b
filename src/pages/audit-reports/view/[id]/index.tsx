...
import { getAuditReportById } from 'apiSdk/audit-reports';
import { AuditReportInterface } from 'interfaces/audit-report';

function AuditReportViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('audit_report', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/audit-reports/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  label="Report Date"
                  text={data?.report_date ? format(parseISO(data?.report_date as unknown as string), 'dd-MM-yyyy') : ''}
                />
