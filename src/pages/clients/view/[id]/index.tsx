...
import { AuditReportListPage } from 'pages/audit-reports';
import { BusinessListPage } from 'pages/businesses';
import { OrganisationListPage } from 'pages/organisations';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('client', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/clients/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="client" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
