...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create': {
    roles: ['organisation-admin', 'business', 'team-member'],
    key: 'new-task-assigned',
    tenantPath: ['client', 'task'],
    userPath: [],
  },
  'task.update': {
    roles: ['super-admin', 'organisation-admin'],
    key: 'task-status-update',
    tenantPath: ['client', 'task'],
    userPath: [],
  },
  'audit_report.create': {
    roles: ['super-admin', 'organisation-admin', 'business'],
    key: 'new-audit-report',
    tenantPath: ['client', 'audit_report'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['super-admin'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['organisation-admin', 'business', 'team-member', 'super-admin'];
